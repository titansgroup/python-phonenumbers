...
PHONE_METADATA_BR = PhoneMetadata(id='BR', country_code=55, international_prefix='00(?:1[245]|2[1-35]|31|4[13]|[56]5|99)',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='1[1-9](?:7|9\\d)\\d{7}|(?:2[12478]|3[1-578]|6[1-9]|7[13-579]|[89][1-9])9?[6-9]\\d{7}|(?:4[1-9]|5[1-5])[6-9]\\d{7}', possible_number_pattern='\\d{10,11}', example_number='11961234567'),
    ...
    shared_cost=PhoneNumberDesc(national_number_pattern='(?:300\\d|40(?:0\\d|20))\\d{4}', possible_number_pattern='\\d{8}', example_number='40041234'),
    ...
    number_format=[NumberFormat(pattern='(\\d{4})(\\d{4})', format='\\1-\\2', leading_digits_pattern=['[2-9](?:[1-9]|0[1-9])'], national_prefix_formatting_rule='\\1'),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{5})(\\d{4})', format='\\1 \\2-\\3', leading_digits_pattern=['(?:[189][1-9]|2[12478]|3[1-578]|7[13-579])9'], national_prefix_formatting_rule='(\\1)', domestic_carrier_code_formatting_rule='0 $CC (\\1)'),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d{2})(\\d{5})(\\d{4})', format='\\1 \\2-\\3', leading_digits_pattern=['(?:[189][1-9]|2[12478]|3[1-578]|7[13-579])9']),
